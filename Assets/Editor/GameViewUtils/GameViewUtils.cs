...
public static class GameViewUtils
{
	...
	[SettingsProvider()]
	private static SettingsProvider GameViewUtils_Prefs()
	{
		// "Game view utils"
		return new SettingsProvider("Preferences/LUT/GameViewUtils", SettingsScope.User)
		{
			label = "Game View Utils",
			...
			keywords = new HashSet<string>(new[] {"view", "lut", "gameview", "game view", "resolution", "aspect" })
	...
	private static void DrawBulkAdd()
	{
		...
		{
			customGameViewCollection = ScriptableObject.CreateInstance<CustomGameViewCollection>();
