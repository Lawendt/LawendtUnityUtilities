...
public static class ExtendedRenderer
{
    ...
    #region Image
     ...
     [System.Obsolete("This is depracted. Use .CrossFadeAlpha")]
    public static void Fade(this Image renderer, float to, float second)
    {
        FadeManager.Instance.Fade(renderer, renderer.color.a, to, second);
    }

    [System.Obsolete("This is depracted. Use .CrossFadeAlpha")]
    public static void Fade(this Image renderer, float from, float to, float second)
    {
        FadeManager.Instance.Fade(renderer, from, to, second);
    }

    [System.Obsolete("This is depracted. Use .CrossFadeAlpha")]
    public static void StopFade(this Image renderer)
    {
    ...
    #region Text
    [System.Obsolete("This is depracted. Use .CrossFadeAlpha")]
    public static void Fade(this Text renderer, float to, float second)
    {
        FadeManager.Instance.Fade(renderer, renderer.color.a, to, second);
    }
    [System.Obsolete("This is depracted. Use .CrossFadeAlpha")]
    public static void Fade(this Text renderer, float from, float to, float second)
    {
        FadeManager.Instance.Fade(renderer, from, to, second);
    }
    [System.Obsolete("This is depracted. Use .CrossFadeAlpha")]
    public static void StopFade(this Text renderer)
    {
        FadeManager.Instance.StopFade(renderer);
    }
